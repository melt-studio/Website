...
useEffect(() => {
  ...
  return (
      ...
      <div id="proj-transation__container" style={{  WebkitTextStrokeColor:props.colorText , backgroundColor: props.colorTheme, color:props.colorText, zIndex:"998" }} className='proj-title-transition__container'>
