...
export const useToggleFullScreen = (iframeRef) => {
  useLayoutEffect(() => {
    ...
    const handleKeyPress = (e) => {
      ...
      if (iframeCurrent.contentWindow.document.activeElement !== iframeCurrent.contentWindow.document.body) return;
    ...
    const handleLoad = () => {
      iframeRef.current.contentWindow.addEventListener("keydown", handleKeyPress);
    };
