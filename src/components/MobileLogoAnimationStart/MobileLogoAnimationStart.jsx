    ...
    <div className="mobile-logo-animation-start__container">
      <div className="drippy-logo__mobile-intro__container">
        ...
        <div style={{ display: `${props.fadeInText}` }}>
          ...
          >
            <p className={pOne} style={{ paddingTop: "60vh", paddingLeft: "5%" }}>
              MELT is a
            </p>
            <p className={pTwo} style={{ position: "relative", bottom: "9vh", paddingLeft: "5%" }}>
              creative
            </p>
            <p className={pThree} style={{ position: "relative", bottom: "18vh", paddingLeft: "5%" }}>
              studio
            </p>
            <p className={pFour} style={{ position: "relative", bottom: "27vh", paddingLeft: "5%" }}>
              bringing
            </p>
            <p className={pFive} style={{ position: "relative", bottom: "36vh", paddingLeft: "5%" }}>
              stories
            </p>
            <p className={pSix} style={{ position: "relative", bottom: "45vh", paddingLeft: "5%" }}>
              to life
            </p>
            <p className={pSeven} style={{ position: "relative", bottom: "54vh", paddingLeft: "5%" }}>
              through
            </p>
            <p className={pEight} style={{ position: "relative", bottom: "63vh", paddingLeft: "5%" }}>
              design.
            </p>
          </div>
        </div>
