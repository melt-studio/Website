...
const Controls = () => {
  ...
  const controlStyle = "control pl-6 pr-1 bg-white/10 hover:bg-white/40";

  return (
    <div
      className={`fixed top-0 left-4 right-4 h-fit gap-2 justify-center flex flex-col md:flex-row flex-wrap items-center font-light text-xs pt-4 md:pt-8 transition-transform duration-2000 delay-2000 md:gap-4 md:text-sm ${
